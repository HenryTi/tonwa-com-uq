...
exports.TagInputBase = TagInputBase;
...
function DefaultBandTemplate(props) {
    ...
    if (label) {
        vLabel = (0, jsx_runtime_1.jsx)("label", __assign({ className: "col-sm-2 col-form-label text-sm-end tonwa-bg-gray-1 border-end" }, { children: (0, jsx_runtime_1.jsx)("b", { children: label }, void 0) }), void 0);
    }
    else {
...
//# sourceMappingURL=TagInputBase.js.map