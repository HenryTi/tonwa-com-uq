            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, tonwa_core_1.refetchApi)(channel, url, options, resolve, reject)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/];
                }
...
var SystemNotifyPage = function (_a) {
    ...
    return (0, jsx_runtime_1.jsx)(components_1.Page, __assign({ header: "\u7CFB\u7EDF\u63D0\u9192" }, { children: (0, jsx_runtime_1.jsx)("div", __assign({ className: "px-3" }, { children: message }), void 0) }), void 0);
};
