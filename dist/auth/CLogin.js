...
var VUserQuit_1 = require("./VUserQuit");
var CLogin = /** @class */ (function (_super) {
    ...
    */
            ...
            return __generator(this, function (_a) {
                ...
                this.openVPage(vPage, function (orgPassword, newPassword) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                centerAppApi = new tonwa_core_1.CenterAppApi(this.web, 'tv/', undefined);
    ...
    CLogin.prototype.showUserQuit = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.openVPage(VUserQuit_1.VUserQuit);
                return [2 /*return*/];
            });
        });
    };
